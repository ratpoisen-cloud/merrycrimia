  ...
  data.forEach((msg, index) => {
    ...
    if (msg.media && msg.media.length > 0) {
        ...
        if (firstMedia.type === 'image') {
            ...
            previewHtml = `<div class="polaroid-img-preview" style="background: #2a2a2a; display:flex; align-items:center; justify-content:center; color:#C9A25B; font-size:28px;"><i class="fas fa-video"></i></div>`;
        }
    } else {
